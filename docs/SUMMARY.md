...
- [Architecture](architecture/README.md)
  ...
  - [Architecture Decision Records](architecture/adr/README.md)
    ...
    - [Rejected]()
- [TaskMail]()
  - [Mainline Guide](taskmail/README.md)
  - [Cleanup Charter](taskmail/documentation-cleanup-charter-v0.1.md)
  ...
  - [Planning Index](taskmail/planning/README.md)
    - [Mainline Roadmap](taskmail/planning/android/taskmail-next-development-plan-v0.2.md)
    - [New Task Track](taskmail/planning/android/taskmail-phase5-new-task-guarded-rollout-observation-plan-v0.1.md)
    - [Reply / Status Track](taskmail/planning/android/taskmail-phase5-reply-status-android-implementation-plan-v0.1.md)
    - [[SYNC] Project List Track](taskmail/planning/android/taskmail-phase5-project-sync-android-implementation-plan-v0.1.md)
  - [Archive Index](taskmail/archive/README.md)
- [User Guide]()
  - [Setup]()
